            ...
            <main class="my-10 grid items-center justify-center gap-4 text-center md:gap-10 lg:gap-16">
              ...
              <section class="grid gap-8 md:gap-16">
                ...
                <div class="space-y-4">
                  ...
                  <p class="text-gray-500">The plugin has a standardized API generated by Connery SDK.<br />Explore the <a href="/api" class="underline">Interactive OpenAPI docs</a> to learn more.</p>
                </div>
                <div class="space-y-4">
