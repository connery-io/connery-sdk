...
Also, there are clients you can use to call actions from your own applications, such as [LangChain](/docs/clients/langchain/tools) or [API](/docs/clients/api) clients.
