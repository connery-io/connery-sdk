...
You have the freedom to select from a diverse range of [clients](/docs/clients/). Detailed information on each client, including its setup and usage instructions, can be found on their respective documentation pages.

For this tutorial, we suggest beginning with the Slack client. Slack is widely used and known for its user-friendly interface.

To proceed with the tutorial, please refer to the [Slack](/docs/clients/slack) client documentation page.

## Next steps

- [Explore plugins](/docs/plugins/)
- [Explore clients](/docs/clients/)
