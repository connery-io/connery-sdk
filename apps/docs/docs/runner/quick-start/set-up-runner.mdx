...
This variable is not required to start the runner. However, some clients based on natural language, like [Slack](/docs/clients/native/slack), won't work without it.
