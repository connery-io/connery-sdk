...
After creating the plugin, the customer hosted it on AWS.
...
The most beautiful thing is that once the plugin is implemented and histed,
...
- Plugin from this use case:
  - The customer built a private plugin for that. However, you can make a similar plugin following our [Create plugin](/docs/quickstart/create-plugin) guide.
