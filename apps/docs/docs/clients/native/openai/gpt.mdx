...
1. Make sure you have a Connery runner up and running.
   You can use the [Quickstart](/docs/platform/quick-start/) guide to set it up.
...
The `<PUBLIC_RUNNER_URL>` you should get during the runner setup in the [Quickstart](/docs/platform/quick-start/) guide.
