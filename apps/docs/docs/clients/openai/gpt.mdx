...
The OpenAI GPTs client does not yet support the new version, but we are working on it. Stay tuned for updates.
...
The `<PUBLIC_RUNNER_URL>` you should get during the runner setup in the [Quickstart](/docs/quickstart/) guide.
