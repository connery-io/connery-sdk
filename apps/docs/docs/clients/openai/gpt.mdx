...
1. **Get the OpenAPI specification** with all the actions from your plugin server.x

   Send the following request to your plugin server to get the OpenAPI specification for the OpenAI GPTs:
...
8. Paste the API Key of your plugin server into the **API Key** field.
