...
The entry point of the plugin is the `./index.js` file that contains the plugin definition.
...
- The new action will be included in the plugin definition in the `./index.js` file.
