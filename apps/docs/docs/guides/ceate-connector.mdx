...
<details>
  <summary>Hint for beginners</summary>

If you are not familiar with GitHub, you can follow the [Create a GitHub repository](https://docs.github.com/en/get-started/quickstart/create-a-repo?tool=webui) guide.
...
You can also install the Connery CLI on your development environment and use it to initialize the connector repository:
...
To continue with the connector development, you need to install all the dependencies that are required by the connector:
...
add new action file into the action folder, include the action in the connector definition file, add an empty test file into the test folder.
