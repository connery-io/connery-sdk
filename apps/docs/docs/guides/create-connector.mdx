...
:::tip
We sincerely encourage making connectors public and open-source.<br/>
Let's empower the community together and make a lasting, positive impact ❤️
:::
...
1. Use the [existing open-source connectors](/docs/connectors) as an inspiration and example.
