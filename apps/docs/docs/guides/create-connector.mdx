...
- Name repository with the name of your future connector.
...
TODO: mention shortcut produced by CLI to run the action faster with the same paramnters next time
