...
- Check the [plugin definition schema](https://github.com/connery-io/connery/blob/main/packages/lib/src/plugin.schema.ts)
...
2. [Install the plugin on the runner.](/docs/quick-start/install-plugin-on-the-runner)
3. [Use clients](/docs/quick-start/use-clients-to-call-actions) to run actions from the plugin.
