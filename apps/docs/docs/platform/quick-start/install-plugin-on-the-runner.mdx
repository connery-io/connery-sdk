...
run the `ClearPluginCache` action of the `connery-io/connery-runner-administration@main` plugin as was shown [on the previous page](/docs/quick-start/set-up-runner#run-action-using-api).
...
Now, when you have the runner configured and the plugins installed, you can learn how to [use clients](/docs/quick-start/use-clients-to-call-actions) to call actions from the plugins.
