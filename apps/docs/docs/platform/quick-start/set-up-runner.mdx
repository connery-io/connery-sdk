...
This variable is not required to start the runner. However, some clients based on natural language, like [Slack App](/docs/native-clients/slack), won't work without it.
...
Now, when you have the runner up and running, let's learn how to [install plugin](/docs/quick-start/install-plugin-on-the-runner) on it.
