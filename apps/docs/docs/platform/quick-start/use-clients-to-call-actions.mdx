...
- [What is an action?](/docs/platform/introduction/core-concepts#action)
...
You can choose any client you like from the growing lists of [native clients](/docs/clients/native/) or [community clients](/docs/clients/community).
...
To continue the tutorial, please refer to the [Slack App](/docs/clients/native/slack) client documentation page.
