...
- Plugin, its source code, and documentation for this use case:
...
- Clients and their documentation for this use case:
  - [Slack App](https://docs.connery.io/docs/clients/native/slack)
  - [Make App](https://docs.connery.io/docs/clients/native/make)
