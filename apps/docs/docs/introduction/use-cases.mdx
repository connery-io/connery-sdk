...
| Event planning chatbot with event registration integration      | Eventbrite, [doo](https://github.com/viovendi/product-api-plugin) | Chat-based  | Event bot handles chat registrations and sends tickets via Eventbrite or doo.                                  | Simplifies registration and enhances attendee experience.          |
