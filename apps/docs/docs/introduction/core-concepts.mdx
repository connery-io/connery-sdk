...
Each connector is represented by a GitHub repository with a specific structure.
GitHub is an excellent infrastructure for connectors that provides all the necessary tools
...
the [connery-io/gmail](https://github.com/connery-io/gmail) connector. It has Recipient, Subject, and Body input parameters.
