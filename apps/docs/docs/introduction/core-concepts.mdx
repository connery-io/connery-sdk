...
for the development and maintenance: version control, collaboration, automation, and more.
...
during the installation on the runner, so the actions has access to the Gmail account.
:::
